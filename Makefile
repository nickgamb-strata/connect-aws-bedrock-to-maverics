...
# Cloudflare Tunnel lifecycle. Requires `cloudflared` installed and logged in,
# and cloudflared/config.yml created from cloudflared/config.yml.template.
tunnel:
	cloudflared tunnel --config cloudflared/config.yml run

# AgentCore lifecycle. Requires AWS CLI configured.
agentcore-bootstrap:
